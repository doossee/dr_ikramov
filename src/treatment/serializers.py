...
class ServiceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'price_start', 'price_end'
        ]
...
class ReportSerializer(serializers.ModelSerializer):
    ...
    profits = ProfitSerializer(many=True, read_only=True)
    consumptions = ConsumptionSerializer(many=True, read_only=True)
    total_profit = serializers.DecimalField(max_digits=11, decimal_places=2, read_only=True)
    total_consumption = serializers.DecimalField(max_digits=11, decimal_places=2, read_only=True)
    net_profit = serializers.DecimalField(max_digits=11, decimal_places=2, read_only=True)
